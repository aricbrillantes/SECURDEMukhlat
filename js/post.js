$(document).ready(function () {
    ...
    $(".edit-btn").on("click", function () {
        ...
        $.ajax({
            url: window.location.origin + "/SECURDEMukhlat/topic/load_post/edit",
            type: "POST",
            dataType: "json",
            ...
            success: function (data) {
                ...
                $("#edit-post-form").attr("action", window.location.origin + "/SECURDEMukhlat/topic/edit_post/" + data.edit_post.post_id);
    ...
    $(".delete-btn").on("click", function () {
        var val = $(this).val();
        $("#delete-post-form").attr("action", window.location.origin + "/SECURDEMukhlat/topic/delete_post/" + val);
    ...
    $(".attachment-btn").on("click", function () {
        ...
        $.ajax({
            url: window.location.origin + "/SECURDEMukhlat/upload/load_post_attachments/" + val + "/1",
            type: "POST",
    ...
    $("#thread-attachment-btn").on("click", function () {
        ...
        $.ajax({
            url: window.location.origin + "/SECURDEMukhlat/upload/load_post_attachments/" + val + "/0",
            type: "POST",
            success: function (html) {
                $("#attachment-modal-container").remove();
                $(".modal-backdrop").remove();
    ...
    $(document).on('click', ".image-attach-view", function () {
        ...
        $.ajax({
            url: window.location.origin + "/SECURDEMukhlat/upload/get_attachment_url/" + val,
            type: "POST",
            dataType: "json",
            success: function (data) {
                $("#image-attachment").attr('src', window.location.origin + "/SECURDEMukhlat/" + data.url);
    ...
    $(document).on('click', ".audio-attach-view", function () {
        ...
        $.ajax({
            ...
            dataType: "json",
            success: function (data) {
                $("#audio-attachment").attr('src', window.location.origin + "/SECURDEMukhlat/" + data.url);
    ...
    $(document).on('click', ".video-attach-view", function () {
        ...
        $.ajax({
            ...
            dataType: "json",
            success: function (data) {
                $("#video-attachment").attr('src', window.location.origin + "/SECURDEMukhlat/" + data.url);
...
function vote(vote_btn, vote_type) {
    ...
    $.ajax({
        url: window.location.origin + "/SECURDEMukhlat/topic/vote/" + post_id,
        type: "POST",
        data: data,
        success: function (data) {
            //optimize
