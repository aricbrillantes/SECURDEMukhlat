    ...
    <div class="modal-dialog" style="width:50%">
        ...
        <div class="modal-content">
            <div class="modal-header modal-heading modalbg">
                ...
                <h4 class="modal-title text-center"><strong><i class="glyphicon glyphicon-camera"></i> Take a photo</strong></h4>
            </div>
            <div class="modal-body">
                <div class = "row"><center>
                    <span style="font-size: 32px">Take a Selfie
  <div class="app">
    <a href="#" id="start-camera" class="visible">Touch here to start the camera.</a>
